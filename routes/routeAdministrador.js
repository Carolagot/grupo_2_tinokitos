...
router.post("/createProduct", upload.any("fotosProductos"),administradorController.createProductPost);
router.get("/eliminarProducto", administradorController.eliminarProducto);
router.delete("/eliminarProducto", administradorController.eliminarProductoDelete);
